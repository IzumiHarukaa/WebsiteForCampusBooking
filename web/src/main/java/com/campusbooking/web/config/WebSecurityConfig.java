 ...
 * It defines URL access rules, the login page, and the password encoding
 * mechanism.
 */
@Configuration
@EnableWebSecurity
public class WebSecurityConfig {
    ...
    // Inject our custom success handler, which contains the logic for role-based
    // redirects.
    @Autowired
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        // This includes the root, login, registration, "no pending requests" page, and
                        // all CSS files.
                        .requestMatchers("/", "/login", "/register", "/no-pending-requests", "/admin/reset", "/css/**",
                                "/style.css")
                        .permitAll()
